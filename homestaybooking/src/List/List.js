...
import hmsty1 from '../Assets/hmsty1.jpeg'; // Import image
import hmsty2 from '../Assets/hmsty2.jpeg'; // Import image
import hmsty3 from '../Assets/hmsty3.jpeg'; // Import image
        ...
        <div className='container text-center mt-5'>
            ...
            <div className="card-list col d-flex justify-content-center flex-wrap">
                ...
                <div className="card mb-3" style={{ width: "18rem" }}>
                    <img src={hmsty1} className="card-img-top h-50" alt="Cozy Homestay" /> {/* Use imported image */}
                ...
                <div className="card mb-3" style={{ width: "18rem" }}>
                    <img src={hmsty2} className="card-img-top h-50" alt="Nha Homestay" /> {/* Use imported image */}
                    <div className="card-body">
                ...
                <div className="card mb-3" style={{ width: "18rem" }}>
                    <img src={hmsty3} className="card-img-top h-50" alt="Nha Minh Homestay" /> {/* Use imported image */}
                    <div className="card-body">
